<x-backend.layouts.master>
    ...
    <div class="overflow-x-auto">
        ...
        <form action="{{ route('admin.categories.update', $category->uuid) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="5"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4">{{ old('description', $category->description) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="remarks" id="remarks" rows="2"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4">{{ old('remarks', $category->remarks) }}</textarea>
            </div>
            ...
            <div class="mb-4 flex items-center gap-2">
                ...
                <input type="hidden" name="status" id="status" value="{{ $category->status ? '1' : '0' }}">
            </div>
